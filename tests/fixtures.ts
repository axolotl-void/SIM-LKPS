...
export const ROLES = {
  ADMIN: { email: 'admin@ubbg.ac.id', password: 'SANDI_LAMA_ADMIN_DIHAPUS' },
  OPERATOR: { email: 'operator@ubbg.ac.id', password: 'SANDI_LAMA_OPERATOR_DIHAPUS' },
  PIMPINAN: { email: 'pimpinan@ubbg.ac.id', password: 'SANDI_LAMA_PIMPINAN_DIHAPUS' },
} as const;
