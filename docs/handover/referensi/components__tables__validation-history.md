# `components/tables/validation-history.tsx`
...
| **Dipakai oleh** | 31 berkas |

## Maksud berkas

Berkas ini menyediakan 1 fungsi utama: `ValidationHistory`.

## Letak berkas

Dari akar repo: `components/tables/validation-history.tsx`.
