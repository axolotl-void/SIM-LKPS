# `app/(dashboard)/master/mata-kuliah/MataKuliahActions.tsx`
...
Berkas ini menyediakan 1 fungsi utama: `MataKuliahActions`.

## Letak berkas

Dari akar repo: `app/(dashboard)/master/mata-kuliah/MataKuliahActions.tsx`.
