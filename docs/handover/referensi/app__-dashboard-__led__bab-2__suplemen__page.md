# `app/(dashboard)/led/bab-2/suplemen/page.tsx`
...
| **Ukuran** | 45 baris |
| **Jenis** | modul biasa |
| **Alamat URL** | `/led/bab-2/suplemen` |
| **Dipakai oleh** | 0 berkas |

## Maksud berkas

Berkas halaman untuk alamat `/led/bab-2/suplemen`. Tugasnya menyiapkan data di server (dan memeriksa izin), lalu menyerahkan tampilan ke komponen client.

## Letak berkas

Dari akar repo: `app/(dashboard)/led/bab-2/suplemen/page.tsx`.
...
Halaman ini bisa dibuka di `/led/bab-2/suplemen`.
