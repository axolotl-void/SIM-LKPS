# `app/(dashboard)/master/mahasiswa/MahasiswaActions.tsx`
...
Berkas ini menyediakan 1 fungsi utama: `MahasiswaActions`.

## Letak berkas

Dari akar repo: `app/(dashboard)/master/mahasiswa/MahasiswaActions.tsx`.
