# `app/(dashboard)/lkps/kriteria-1/error.tsx`
...
Tampilan yang muncul kalau halaman ini gagal dimuat, supaya pengguna tidak melihat layar putih.

## Letak berkas

Dari akar repo: `app/(dashboard)/lkps/kriteria-1/error.tsx`.
