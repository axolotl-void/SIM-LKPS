# `app/(dashboard)/dashboard/ProgressSection.tsx`
...
Berkas ini menyediakan 1 fungsi utama: `ProgressSection`.

## Letak berkas

Dari akar repo: `app/(dashboard)/dashboard/ProgressSection.tsx`.
