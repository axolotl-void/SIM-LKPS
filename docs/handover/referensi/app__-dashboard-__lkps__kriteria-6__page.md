# `app/(dashboard)/lkps/kriteria-6/page.tsx`
...
Berkas halaman untuk alamat `/lkps/kriteria-6`. Tugasnya menyiapkan data di server (dan memeriksa izin), lalu menyerahkan tampilan ke komponen client.

## Letak berkas

Dari akar repo: `app/(dashboard)/lkps/kriteria-6/page.tsx`.
...
Halaman ini bisa dibuka di `/lkps/kriteria-6`.
