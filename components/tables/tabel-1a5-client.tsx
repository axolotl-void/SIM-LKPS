...
import {
  ...
  GraduationCap,
  Briefcase, CheckCircle2, X, Save, AlertTriangle, Info
} from "lucide-react";
...
export function Tabel1A5Client({ initialRows, tahunAkademikId, tabelKode, status, userRole: _userRole }: Tabel1A5ClientProps) {
