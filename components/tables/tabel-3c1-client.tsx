  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <Link href="/lkps/kriteria-3" className="flex items-center gap-2 text-xs font-bold text-slate-800 hover:text-violet-600 transition-colors"><ArrowLeft className="h-4 w-4" /> Kembali ke Kriteria 3</Link>
