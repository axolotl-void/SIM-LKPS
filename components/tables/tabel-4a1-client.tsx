...
export function Tabel4A1Client({ initialRows, tahunAkademikId, tabelKode, status, userRole }: Props) {
      ...
      <div className="rounded-2xl border-2 border-amber-200/70 bg-white shadow-soft overflow-hidden">
        ...
        {rows.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-sm font-semibold text-slate-800">Belum ada data prasarana PkM.</p>
            <p className="text-xs text-slate-700 mt-1">Klik &ldquo;Tambah Prasarana PkM&rdquo; di atas untuk memulai.</p>
          </div>
        ) : (
