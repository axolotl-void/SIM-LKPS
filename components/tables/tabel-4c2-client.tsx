...
import {
  ...
  Share2, Globe, Edit2, AlertTriangle,
} from "lucide-react";
...
export function Tabel4C2Client({ initialRows, tahunAkademikId, tabelKode, status, userRole, dosens }: Props) {
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {[
            { label: "Total Diseminasi", value: rows.length, color: "text-slate-800" },
            { label: "Lokal", value: lokal, color: "text-cyan-600" },
            { label: "Nasional", value: nasional, color: "text-blue-600" },
            { label: "Internasional", value: internasional, color: "text-indigo-600" },
          ].map((card) => (
            <div
              key={card.label}
