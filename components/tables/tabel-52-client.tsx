      ...
      <div className="rounded-2xl border-2 border-slate-200/70 bg-white shadow-soft overflow-hidden">
        ...
        {rows.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-sm font-semibold text-slate-800">Belum ada data prasarana pendidikan.</p>
            <p className="text-xs text-slate-700 mt-1">Klik &ldquo;Tambah Prasarana Pendidikan&rdquo; di atas untuk memulai.</p>
          </div>
        ) : (
