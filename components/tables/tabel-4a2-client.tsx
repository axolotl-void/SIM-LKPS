...
import {
  ...
  Users, HeartHandshake, DollarSign, Edit2, AlertTriangle,
} from "lucide-react";
...
export function Tabel4A2Client({ initialRows, tahunAkademikId, tabelKode, status, userRole, dosens }: Props) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border-2 border-orange-200/70 bg-white shadow-soft overflow-hidden">
        <div className="bg-gradient-to-r from-teal-500 to-emerald-600 px-7 py-4">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 overflow-y-auto">
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-500 to-emerald-600 text-white shadow-soft-sm">
...
<DosenSelect
                        ...
                        {(["L", "N", "I"] as const).map((v) => (
                          <button
                            ...
                            className={`flex-1 rounded-xl px-2 py-2.5 text-xs font-bold transition-all ${
                              form.jenisHibah === v
                                ? "bg-gradient-to-tr from-teal-500 to-emerald-600 text-white shadow-soft-sm"
                ...
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="flex items-center gap-2 rounded-xl bg-gradient-to-tr from-teal-500 to-emerald-600 px-6 py-2.5 text-xs font-bold text-white shadow-soft-sm hover:shadow-soft transition-all disabled:opacity-60"
                  >
                    {isLoading ? (
