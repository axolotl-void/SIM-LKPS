...
export const metadata = { title: "Kriteria 4 — Relevansi PkM" };
    ...
    <div className="min-h-screen pb-12">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-white/60 text-xs font-bold uppercase tracking-widest">KRITERIA 4 • Relevansi PkM</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {tables.map((table, index) => {
          ...
          return (
            <Link key={table.kode} href={`/lkps/kriteria-4/tabel-${table.kode.replace(/\./g, "").toLowerCase()}`} className={`group relative block animate-fade-in-up ${staggerClass}`}>
