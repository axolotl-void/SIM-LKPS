...
import { Award, Calendar, BookOpen, FileText, CheckCircle2, Clock, AlertCircle, XCircle } from "lucide-react";
...
export default async function Tabel3C3Page() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ErrorBoundary>
        <Tabel3C3Client initialRows={rows} tahunAkademikId={activeTa.id} tabelKode={def.kode} status={status} userRole={session.user.role} />
      </ErrorBoundary>
