...
export default function Loading() {
  return (
    <div className="min-h-screen pb-12">
      {/* Hero skeleton */}
      <div className="h-48 rounded-2xl bg-gradient-to-br from-teal-600 via-cyan-600 to-sky-600 mb-6 shadow-xl skeleton" />

      {/* Cards skeleton */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="h-72 rounded-2xl bg-white border border-slate-100 shadow-lg overflow-hidden">
            <div className="h-20 bg-gradient-to-br from-teal-500 via-cyan-500 to-sky-500 skeleton" />
