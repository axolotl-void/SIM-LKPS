...
const Tabel4A1Client = dynamic(() =>
  import("@/components/tables/tabel-4a1-client").then((m) => m.Tabel4A1Client)
);
...
export default async function Tabel4A1Page() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ErrorBoundary>
        <Tabel4A1Client initialRows={rows} tahunAkademikId={activeTa.id} tabelKode={def.kode} status={status} userRole={session.user.role as Role} />
      </ErrorBoundary>
