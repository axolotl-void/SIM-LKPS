...
const Tabel2B6Client = dynamic(() =>
  import("@/components/tables/tabel-2b6-client").then((m) => m.Tabel2B6Client)
);
...
export default async function Tabel2B6Page() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ErrorBoundary>
        <Tabel2B6Client initialRows={rows} tahunAkademikId={activeTa.id} tabelKode={def.kode} status={status} userRole={session.user.role as Role} />
      </ErrorBoundary>
      {history.length > 0 && (
